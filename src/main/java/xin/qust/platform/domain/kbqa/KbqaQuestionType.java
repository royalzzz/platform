...
@Entity
@Table(name = "kbqa_question_type")
public class KbqaQuestionType {
    ...
    @JoinTable(name = "kbqa_question_tag_type", joinColumns = @JoinColumn(name = "question_type_id"), inverseJoinColumns =  @JoinColumn(name = "question_text_id"))
